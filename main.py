...
def getprice(url):
	...
	accumAdjFactor=[]
	for i in num_ser: 
		preClosePrice.append(re["data"][i]["preClosePrice"])
		openPrice.append(re["data"][i]["openPrice"])
		highestPrice.append(re["data"][i]["highestPrice"])
		lowestPrice.append(re["data"][i]["lowestPrice"])	
		closePrice.append(re["data"][i]["closePrice"])
		accumAdjFactor.append(re["data"][i]["accumAdjFactor"])
	for i in num_ser:
